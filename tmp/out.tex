...
\begin{document}
  ...
  \section{Contact Information}\label{contact-information}}
    ...
    \begin{minipage}[t]{0.7\textwidth}
                {\textit{Tel:}} 26630 81966 \\
                        {\textit{E-mail:}} c13@garn.gr \\
                        {\textit{Web:}} http://https://bgarnb.github.io/simple-cv/ \\
...
\tightlist
\item
  \textbf{Διδακτορικό PhD, Ιόνιο Πανεπιστήμιο, Τμήμα Πληροφορικής}, 2017
...
\item
  ...
  Σπουδές, Ιόνιο Πανεπιστήμιο, Τμήμα Πληροφορικής}, MSC, 2013
\item
